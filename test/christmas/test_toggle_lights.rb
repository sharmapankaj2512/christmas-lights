...
module Christmas
  class TestToggleLights < Minitest::Test
    def test_toggle_lights
      grid = Grid.new(1)
      grid.toggle(TwoDimensionalRange.new([0, 0], [0, 0]))
      grid.toggle(TwoDimensionalRange.new([0, 0], [0, 0]))
    ...
    def test_toggle_two_by_two
      grid = Grid.new(2)
      grid.toggle(TwoDimensionalRange.new([0, 1], [0, 1]))
      grid.toggle(TwoDimensionalRange.new([0, 1], [0, 1]))
    ...
    def test_toggle_two_by_two_horizontal_line
      grid = Grid.new(2)
      grid.toggle(TwoDimensionalRange.new([0, 0], [1, 0]))
    ...
    def test_toggle_two_by_two_vertical_line
      grid = Grid.new(2)
      grid.toggle(TwoDimensionalRange.new([0, 0], [0, 1]))
    ...
    def test_toggle_two_by_two_square
      grid = Grid.new(2)
      grid.toggle(TwoDimensionalRange.new([0, 0], [1, 1]))
